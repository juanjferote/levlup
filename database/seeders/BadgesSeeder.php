...
class BadgesSeeder extends Seeder
{
    public function run(): void
    {
        $badges = [
            ...
            // ============ HÁBITOS POR CATEGORÍA — DESCANSO ============
            ['name' => 'Soñador',             'description' => 'Tu primera semana cuidando el descanso. El sueño es el combustible del éxito.',         'icon' => '🌙', 'rarity' => 'comun',      'category' => 'descanso',      'condition_type' => 'habit_category', 'condition_value' => 1],
            ['name' => 'Viajero Onírico',     'description' => 'Cuatro semanas durmiendo como mereces. Tus sueños son tu segundo mundo.',               'icon' => '💫', 'rarity' => 'rara',       'category' => 'descanso',      'condition_type' => 'habit_category', 'condition_value' => 4],
            ['name' => 'Guardián del Sueño',  'description' => 'Ocho semanas protegiendo tu descanso. Nada interrumpe tu paz nocturna.',                'icon' => '🌌', 'rarity' => 'epica',      'category' => 'descanso',      'condition_type' => 'habit_category', 'condition_value' => 8],
            ['name' => 'Señor de los Sueños', 'description' => 'Dieciséis semanas de descanso perfecto. Dominas el arte de recuperarte.',               'icon' => '👁️', 'rarity' => 'legendaria', 'category' => 'descanso',      'condition_type' => 'habit_category', 'condition_value' => 16],
            ...
            ['name' => 'Amigo de tus amigos',  'description' => 'Cuatro semanas siendo la mejor versión de ti en tus relaciones.',                     'icon' => '🤝', 'rarity' => 'rara',       'category' => 'social',        'condition_type' => 'habit_category', 'condition_value' => 4],
            ...
            ['name' => 'Una persona nueva',   'description' => 'Trescientos sesenta y cinco días sin caer. Has reescrito tu historia por completo.',   'icon' => '🦋', 'rarity' => 'legendaria', 'category' => null, 'condition_type' => 'habit_dejar', 'condition_value' => 365],
            ...
            ['name' => 'Polivalente',  'description' => 'Hábitos activos en cuatro áreas distintas. Tu crecimiento no tiene fronteras.',               'icon' => '🔀', 'rarity' => 'rara',       'category' => null, 'condition_type' => 'diversity', 'condition_value' => 4],
            ...
            ['name' => 'Cartógrafo', 'description' => 'Añadiste tu primer interés personalizado. Eres dueño de tu propio camino.',                     'icon' => '🗺️', 'rarity' => 'comun',      'category' => null, 'condition_type' => 'custom_interests', 'condition_value' => 1],
            ...
            ['name' => 'Profeta',    'description' => 'Cinco intereses personalizados activos. Has creado tu propia versión de LevlUp.',               'icon' => '🌐', 'rarity' => 'epica',      'category' => null, 'condition_type' => 'custom_interests', 'condition_value' => 5],
            ...
            ['name' => 'Arrollador',          'description' => 'Cincuenta misiones completadas. Nada en tu lista de tareas te detiene.',              'icon' => '🏃', 'rarity' => 'rara',       'category' => null, 'condition_type' => 'tasks_completed', 'condition_value' => 50],
            ['name' => 'Maestro de Misiones', 'description' => 'Cien misiones completadas. Las misiones tiemblan cuando abres la app.',               'icon' => '🎖️', 'rarity' => 'epica',      'category' => null, 'condition_type' => 'tasks_completed', 'condition_value' => 100],
            ...
            // ============ RACHAS GLOBALES ============
            ['name' => 'Perseverante', 'description' => 'Siete días consecutivos de actividad. La constancia es tu superpoder.',                      'icon' => '🔥', 'rarity' => 'comun',      'category' => null, 'condition_type' => 'global_streak', 'condition_value' => 7],
            ...
            ['name' => 'Incansable',   'description' => 'Noventa días consecutivos de actividad. Ni el cansancio puede contigo.',                     'icon' => '🦅', 'rarity' => 'epica',      'category' => null, 'condition_type' => 'global_streak', 'condition_value' => 90],
            ['name' => 'Eterno',       'description' => 'Ciento veinte días consecutivos. Eres una fuerza de la naturaleza imparable.',                     'icon' => '⭐', 'rarity' => 'legendaria', 'category' => null, 'condition_type' => 'global_streak', 'condition_value' => 120],
            ...
            ['name' => 'Aventurero',         'description' => 'Alcanzaste el nivel 5. Ya no eres un novato, eres un verdadero aventurero.',           'icon' => '⚔️', 'rarity' => 'comun',      'category' => null, 'condition_type' => 'level', 'condition_value' => 5],
            ['name' => 'Héroe',              'description' => 'Alcanzaste el nivel 8. Tu dedicación te ha convertido en un héroe de LevlUp.',         'icon' => '🛡️', 'rarity' => 'comun',      'category' => null, 'condition_type' => 'level', 'condition_value' => 8],
            ['name' => 'Élite',              'description' => 'Alcanzaste el nivel 11. Formas parte de los pocos que llegan hasta aquí.',             'icon' => '🔱', 'rarity' => 'rara', 'category' => null, 'condition_type' => 'level', 'condition_value' => 11],
            ['name' => 'Maestro',            'description' => 'Alcanzaste el nivel 14. Has dominado lo que otros apenas comprenden.',                 'icon' => '🌠', 'rarity' => 'rara', 'category' => null, 'condition_type' => 'level', 'condition_value' => 14],
            ['name' => 'Gran Maestro',       'description' => 'Alcanzaste el nivel 17. Tu dedicación roza lo extraordinario.',                       'icon' => '🔮', 'rarity' => 'epica',      'category' => null, 'condition_type' => 'level', 'condition_value' => 17],
            ['name' => 'Leyenda del Tiempo', 'description' => 'Nivel máximo alcanzado. Has trascendido los límites. Eres una leyenda para siempre.', 'icon' => '🌟', 'rarity' => 'legendaria', 'category' => null, 'condition_type' => 'level', 'condition_value' => 20],

            // ============ ESPECIALES ============
            ['name' => 'El Fin del Camino', 'description' => 'Completaste la defensa de tu proyecto final. Este es solo el principio.', 'icon' => '🎓', 'rarity' => 'legendaria', 'category' => null, 'condition_type' => 'special_task', 'condition_value' => 999],
